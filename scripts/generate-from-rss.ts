    ...
    const feedItems = [
      {
        ...
        content:
          "Arsenal are finalizing a British record £105m deal for West Ham captain Declan Rice. The England midfielder has agreed personal terms and will undergo medical this week. Deal includes £100m upfront plus £5m in add-ons.",
      ...
      },
      {
        ...
        content:
          "Liverpool have completed the signing of Brighton midfielder Alexis Mac Allister for £35m. The World Cup winner has signed a five-year contract and will join when the transfer window opens. Medical already completed.",
        sourceId: manualSource.id,
      ...
      },
      {
        ...
        content:
          "Bayern Munich have made contact with Tottenham over Harry Kane. The German champions are preparing a €100m bid for the England captain. Kane has one year left on his contract and is considering his options.",
        sourceId: manualSource.id,
      ...
      },
      {
        ...
        content:
          "Real Madrid have announced the signing of Jude Bellingham from Borussia Dortmund for €103m. The 19-year-old England midfielder has signed a six-year contract. He will wear the number 5 shirt.",
        sourceId: manualSource.id,
        type: FeedItemType.CONFIRMED,
      ...
      },
      {
        ...
        content:
          "Chelsea are preparing a club-record bid for Brighton midfielder Moises Caicedo. The Blues are willing to pay over £100m for the Ecuadorian. Brighton are reluctant to sell but may consider a huge offer.",
        sourceId: manualSource.id,
      ...
      },
      {
        ...
        content:
          "Paris Saint-Germain have made an enquiry for Marcus Rashford. The French champions are testing Manchester United's resolve with a €100m opening bid. United insist the England forward is not for sale.",
        sourceId: manualSource.id,
