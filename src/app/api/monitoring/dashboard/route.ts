  ...
  try {
    ...
    const response: any = {
      ...
      configuration: {
        ...
        terryVoiceThreshold: CONFIG.pipeline.quality.thresholds.terryVoice,
        ...
        cacheEnabled: CONFIG.pipeline.performance.cacheEnabled,
        websocketHeartbeat:
          CONFIG.pipeline.performance.websocketHeartbeat + "ms",
      },
